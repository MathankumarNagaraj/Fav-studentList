...
function List({ favoriteList, addToFavorites }) {
   const mylist = [ "Vijay-Leo", "Ajith-Thunivu", "Suriya-Rolex", "Karthi-Dhelli","sivakarthikeyan-Amaran"];

   return (
      <>
         {/* Navbar */}
         <div className="bg-[rgb(71,223,223)] p-4 flex justify-between">
                     ...
                     <button
                        ...
                        className={`px-4 py-2 rounded-lg ${
                           favoriteList.includes(item)
                              ...
                              : "bg-[#4E4E4E] text-white hover:bg-green-600"
                        }`}
                     >
